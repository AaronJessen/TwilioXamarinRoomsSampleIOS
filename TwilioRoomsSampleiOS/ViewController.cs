...
namespace TwilioRoomsSampleiOS
{
	...
	{
		// Token coming from sample PHP token generator from README.md
		// Or consider using Azure Functions to generate token
		// https://github.com/jonedavis/TwilioAzureFuctionsTokenGenerator
#if DEBUG
		private const string TokenUrl = @"https://<YOUR SERVER HERE>/token";
#else
        private const string TokenUrl = @"https://<YOUR SERVER HERE>/token";
#endif
